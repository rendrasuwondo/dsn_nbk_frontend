        ...
        <div class="card-body">
          <div class="form-group">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <nuxt-link
                  :to="{ name: 'erp_nbk-admin-employee-create' }"
          ...
          >
            <template v-slot:cell(actions)="row">
              <b-button
                :to="{
                  name: 'erp_nbk-admin-employee-edit-id',
            ...
            <template v-slot:cell(employee_afdeling)="row">
              <b-button
                :to="{
                  name: 'erp_nbk-admin-employee_afdeling-id',
                  params: {
                    id: row.item.id,
                  },
                }"
            ...
            <template v-slot:cell(employee_department)="row">
              <b-button
                :to="{
                  name: 'erp_nbk-admin-employee_department-id',
                  params: {
                    id: row.item.id,
                  },
                }"
            ...
            <template v-slot:cell(employee_position)="row">
              <b-button
                :to="{
                  name: 'erp_nbk-admin-employee_position-id',
                  params: {
                    id: row.item.id,
                  },
                }"
            ...
            <template v-slot:cell(employee_activity_group)="row">
              <b-button
                :to="{
                  name: 'erp_nbk-admin-employee_activity_group-id',
                  params: {
                    id: row.item.id,
                  },
                }"
